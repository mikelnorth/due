SELECT DISTINCT a.assignment_id, a.assignment_name as title, a.datetime as start, a.datetime as end, c.class_name as desc, a.points_possible, uc.color, ua.completed FROM users as u
...
WHERE uc.user_id = $1 and u.user_id = $1;